...
export default function SignUpPage(){
    ...
    const onSubmit=(data)=>{
        console.log(data) ; //{name:'manager', email:'manager@gmail.com', password:'123456789'};
        setDataSignUp(data)
        setMode('PRICING')
    }
  return (
              ...
              <div className="relative flex flex-col flex-1 p-[10px]">
                  ...
                  <div className="flex items-center justify-center gap-[109px] my-auto">
                      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col w-[400px] h-fit rounded-[20px] border border-[#262A56] p-[30px] gap-[30px] bg-[#080A2A]">
                          ...
                          <hr className="border-[#262A56]" />
                          <button type="submit" className="w-full rounded-full border p-[14px_20px] text-center font-semibold text-white bg-[#662FFF] border-[#8661EE] shadow-[-10px_-6px_10px_0_#7F33FF_inset] transition-all duration-300 hover:bg-[#8661EE] hover:border-[#662FFF] 
             hover:shadow-[-10px_-6px_10px_0_#7F33FF_inset] cursor-pointer">
                              Sign Up Now
                          </button>
                      </form>
                      <div className="flex flex-col gap-[30px]">
                          <h1 className="font-extrabold text-[46px] leading-[69px] text-white">Sign Up & Enhance <br></br>Employees Skills</h1>
                          <p className="text-lg leading-[32px] text-white">We delivery robust features to anyone <br></br>unconditionally so they can grow bigger.</p>
                      </div>
                  </div>
              </div>
    ) : (
